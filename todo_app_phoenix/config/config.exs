...
config :todo_app_phoenix,
  ecto_repos: [TodoAppPhoenix.Repo]
...
config :todo_app_phoenix, TodoAppPhoenixWeb.Endpoint,
  ...
  live_view: [signing_salt: "0Z2pfPGi"]
...
config :todo_app_phoenix, TodoAppPhoenix.Mailer, adapter: Swoosh.Adapters.Local
