defmodule TodoAppPhoenix.TasksTest do
  use TodoAppPhoenix.DataCase

  alias TodoAppPhoenix.Tasks

  describe "tasks" do
    alias TodoAppPhoenix.Tasks.Task

    import TodoAppPhoenix.TasksFixtures
